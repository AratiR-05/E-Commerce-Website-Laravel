                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ url('admin/size') }}">Product</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('admin/size/add') }}" style="float: right" class="btn btn-primary">Add
                                    New
                                    +</a>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datas as $list)
                                            <tr>
                                                ...
                                                <td>{{ $list->name }}</td>
                                                <td>
                                                    <a href="{{ url('admin/size/update') }}/{{ $list->id }}"
                                                        title="Edit">
