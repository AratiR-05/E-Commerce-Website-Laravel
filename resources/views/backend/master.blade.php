...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('public/backend/plugins/dist/css/adminlte.min.css') }}">
    @stack('css')
</head>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('admin/') }}" class="nav-link">Logout</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview @if ($active == 'category' || $active == 'view' || $active == 'update') menu-open @endif">
                            <a href="#" class="nav-link  @if ($active == 'category' || $active == 'view' || $active == 'update') active @endif">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/type') }}"
                                        class="nav-link @if ($active == 'type') active @endif">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Type</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/size') }}"
                                        class="nav-link @if ($active == 'size') active @endif">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Size</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/color') }}"
                                        class="nav-link @if ($active == 'color') active @endif">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Color</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/product') }}"
                                        class="nav-link @if ($active == 'product') active @endif">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Product</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/order') }}"
                                class="nav-link @if ($active == 'order') active @endif">
                                <i class="nav-icon far fa-user"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/') }}"
                                class="nav-link @if ($active == 'logout') active @endif">
