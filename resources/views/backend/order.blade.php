                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ url('admin/product') }}">Order</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('admin/order') }}" style="float: right" class="btn btn-primary">Add
                                    New
                                    +</a>
                            </div>
                            <!-- /.card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/product/update') }}/{{ $list->id }}"
                                                    title="Edit">
                                                    <img src="{{ asset('public/backend/icon/edit.png') }}" alt="">
                                                </a>
                                                &nbsp;&nbsp;
