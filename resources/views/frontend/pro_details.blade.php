                                ...
                                <div class="hero-caption hero-caption2">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb justify-content-center">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ url('product') }}">Product
                                                    Details</a>
                                            </li>
                                        </ol>
                                    </nav>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="single-services d-flex align-items-center mb-0">
                                    <div class="features-img">
                                        <img src="{{ asset('storage/app') }}/{{ $detail->imgpath }}" alt>
                                    </div>
                                    <div class="features-caption">
                                        ...
                                        <a href="javascript:void(0)" class="white-btn mr-10"
                                            onclick="showAlert('{{ $detail->proid }}')">Add to Cart</a>
...
@push('js')
    <script>
        function showAlert(proid) {
            var user = '{{ Auth::user()->email ?? '' }}';

            $.get('{{ url('addcart') }}/' + proid + '/' + user, function(response) {
                if (response.success) {
                    getcartcount();
                }
            })
